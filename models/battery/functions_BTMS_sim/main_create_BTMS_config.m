...
ch_orient       = [repelem('x',length(start_layers_x_dir)),...
  repelem('y',length(start_layers_y_dir)), repelem('z',length(start_layers_z_dir))];
% ch_orient = {};
% ch_orient = [ch_orient, repmat({'x'}, 1,length(start_layers_x_dir))];
% ch_orient = [ch_orient, repmat({'y'}, 1,length(start_layers_y_dir))];
% ch_orient = [ch_orient, repmat({'z'}, 1,length(start_layers_z_dir))];
