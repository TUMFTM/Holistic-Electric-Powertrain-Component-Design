...
% !! Debugvalue - Zoe has an NMC_721 Cell !!
% Zoe cell = LGX E78
...
t_cell_capacity = 78.06;   % Cell capacigy C_A  in Ah
...
BatPara.electrical.U_nom = 3.65;                     % Nominal cell voltage in V
BatPara.electrical.Crate_max = 4;                   % maximal allowed C-Rate "agressive cycling"
...
BatPara.physical.dim_x = 12e-3;   % Cell dimension in x-direction
BatPara.physical.dim_y = 285e-3;    % Cell dimension in y-direction
BatPara.physical.dim_z = 143e-3;     % Cell dimension in z-direction

% Cell mass (Calculated from the cell's dimensions and density)
BatPara.physical.m = 1.1355;
...
BatPara.physical.TabWidth = 0.045;           % Tab Width in meters
BatPara.physical.TabHeight = 0.035;          % Tab Height in meters
