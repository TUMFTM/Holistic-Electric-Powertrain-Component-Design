...
BatPara.cellchemistry = "NMC721"; % [NMC111, NMC532, NMC622, NMC811, NCA, LFP, LMO, Sodium ]
% !! Debugvalue - ID3 has an NMC721 Cell !!
...
BatPara.electrical.I_max = BatPara.electrical.Crate_max * BatPara.electrical.C_A;     % Maximum cell current in A (assumption: 2C) --> Warning, this is very high for current gen cells!
...
BatPara.physical.dim_x = 8.65e-3;   % Cell dimension in x-direction
BatPara.physical.dim_y = 545e-3;    % Cell dimension in y-direction
BatPara.physical.dim_z = 107e-3;     % Cell dimension in z-direction
...
BatPara.physical.TabLocation = "Opposed";   % Position of the Tabs
BatPara.physical.TabWidth = 0.04;           % Tab Width in meters
BatPara.physical.TabHeight = 0.03;          % Tab Height in meters
