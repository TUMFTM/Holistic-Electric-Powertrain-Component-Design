...
%%%%%%%%%%%%%%%%%%%%%%% GD %%%%%%%%%%%%%%%%%%%%%%%%
% So far same as: system_specifcations_Cyl_inside
%%%%%%%%%%%%%%%%%%%%%%% GD %%%%%%%%%%%%%%%%%%%%%%%%
...
SysSpec.dim_x_mod_max   = 2;      % Maximum module dimension in x-direction in m
...
SysSpec.mod_min_e       = 1;        % Minimum layers e of cells in module (z-dir)
SysSpec.mod_max_e       = 10;        % Maximum layers e of cells in module (z-dir)
