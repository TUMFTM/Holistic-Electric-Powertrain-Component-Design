...
%%%%%%%%%%%%%%%%%%%%%%% GD %%%%%%%%%%%%%%%%%%%%%%%%
% So far same as: system_specifcations_Pouch_inside
%%%%%%%%%%%%%%%%%%%%%%% GD %%%%%%%%%%%%%%%%%%%%%%%%
...
SysSpec.C_mod_min   = 0;       % Minimum module capacity in Ah
SysSpec.E_mod_min   = 0;        % Minimum module energy in kWh
SysSpec.I_mod_max   = 200;      % Maximum continuous current the module must withstand in A
...
SysSpec.dim_z_mod_max   = 0.3;      % Maximum module dimension in z-direction in m
