function [P_V, total_P_VD, total_P_VZ, total_P_VL] = Getrieberechnung_koaxialFW(Gearbox,Mrad,nrad,Temp)
% Funktion zur Verlustberechnung eines 2-stufigen Strinradgetriebes mit
% koaxialem An/Abtrieb, ebene Anordnung
...
%%%%%%%%%%%%%%%%
%%% Öldaten SAE 70W-75W (API GL4) VW ID3 Getriebeöl
...
%% kinematische Viskosität im Betrieb bei Betriebstemperatur T
...
for k = 1:3
    ...
    T_Q = 0; %Keine Quetschverluste, wenn in Auslauf gespritzt wird (vereinfachte Annahme)
    ...
    a = 70+b/2; b1 = 0; c = 13+b/2; %Extraabstand für Differential
    Welle(3).L1Fax = Fax;
    Welle(3).L2Fax = 0;
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %Dichtung Eingangshohlwelle Motor
