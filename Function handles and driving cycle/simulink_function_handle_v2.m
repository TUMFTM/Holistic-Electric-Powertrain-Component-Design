...
try
    ...
    %config_gearbox.ratio = config_gearbox.iges;
    if GB_Mode == "Analytic" %Analytic Gearbox Design
        %GB_Topology = "achsparallel";%evalin("base","GB_Topology");
    ...
    % disp("Zeitbedarf Getriebeentwurf: ") 
...
%     disp("Batterie bereits gebaut, wird wiederverwendet zum Zeitsparen, AM ENDE UNBEDINGT ENTFERNEN!!")
...
try
    ...
    % disp("Zeitbedarf Motorentwurf & -analyse: ")
